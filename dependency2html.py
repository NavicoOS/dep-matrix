...
# HtmlTableWriter
#   This class is not intended to be useful on its own. It is intended to be used by the
...
class HtmlTableInlineWriter(object):
    ...
    def _GetHeadingIndex(self, heading, headingList):
        if isinstance(heading, basestring):
            if heading in headingList:
                return headingList.index(heading)
    ...
    def WriteData(self, data, columnIndex, rowIndex):
        ...
        if newIndex >= currentIndex:
            ...
            #     [ 4, 5, 6 ]
            #     [ 7, 8, 9 ]
            # For this table to be written you must write out the items in this order:
            #   1, 2, 3, 4, 5, 6, 7, 8, 9
...
class DependencyMatrixHtmlTableWriter(HtmlTableWriter):
    def __init__(self, writerObject, solutionInfo):
        self.writer = writerObject
        self.rowHeadingList = []
...
/* Global style */
body {
    /* See: http://www.w3schools.com/cssref/css_websafe_fonts.asp for a list of available fonts */
    font-family: Verdana, Geneva, sans-serif;
}

/* Style for the div within which hide all the tables containing individual include files */
.headerlist {
    position:   absolute;
    top:        -5;
    z-index:    1;
...
/* Generic table style (applied to all tables) */
table {
...
/* Special corner. Top left. Custom style */
th.corner {
    border-width: 0px;
}

/* Magical header rotation code
 * from: http://css-tricks.com/rotated-table-column-headers/
 */
th.rotate {
...
/* Individual cell highlighting styles */
.self {
...
/* Individual cell highlighting styles after filters are applied */
.js-computed-sum {
    font-weight: bold;
}
.self .js-computed-sum {
    color: #ff0000;
}
.independent .js-computed-sum {
    color: #ff0000;
}
.warning .js-computed-sum {
    color: #ffff00;
}
.error .js-computed-sum {
    color: #ffff00;
}

/* Includes table specific styles */
table.includes-table {
    font-weight: normal;
}
table.includes-table th {
    border-width: 1px;
    border-style: solid;
...
tr.highlight > td.error {
    background-color: #FF8800;
}
tr.highlight > td.warning {
    background-color: #FFD666;
}
tr.highlight > td.independent {
    background-color: #DDDD00;
}
tr.highlight > td.self {
...
.total-violations > span {
    /* Totals summary text */
}
.total-violations > span > span {
    /* Totals summary number */
    font-size: 125%;
}
.legend {
...
input[type="button"].subtable-extra-button {
    width: 150px;
    height: 25px;
}
#inputs-table input[type="button"] {
    width: 50px;
}
#inputs-table input[type="text"] {
    width: 275px;
}
#inputs-table th .title {
    width: 100px;
}

/* Diff highlighting styles for matrix cells */
.diff-same {
...
.warning.diff-added, .independent.diff-added {
...
.error.diff-removed, .warning.diff-removed, .independent.diff-removed {
...
.diff-count {
    font-weight: bold;
        ...
        # JQuery library inclusion. WARNING!!! The library includes escaped characters! Should you
        # ever need to update it ensure that either:
        #   * all \ (slashes) are turned into \\ double-slashes!
        #  or
        #   * Use raw strings e.g. r"some string with \ slashes"
        self.htmlJQuery = r"""<script type="text/javascript">
...
if(k&&j[k]&&(e||j[k].data)||void 0!==d||"string"!=typeof b)return k||(k=i?a[h]=c.pop()||m.guid++:h),j[k]||(j[k]=i?{}:{toJSON:m.noop}),("object"==typeof b||"function"==typeof b)&&(e?j[k]=m.extend(j[k],b):j[k].data=m.extend(j[k].data,b)),g=j[k],e||(g.data||(g.data={}),g=g.data),void 0!==d&&(g[m.camelCase(b)]=d),"string"==typeof b?(f=g[b],null==f&&(f=g[m.camelCase(b)])):f=g,f}}function R(a,b,c){if(m.acceptData(a)){var d,e,f=a.nodeType,g=f?m.cache:a,h=f?a[m.expando]:m.expando;if(g[h]){if(b&&(d=c?g[h]:g[h].data)){m.isArray(b)?b=b.concat(m.map(b,m.camelCase)):b in d?b=[b]:(b=m.camelCase(b),b=b in d?[b]:b.split(" ")),e=b.length;while(e--)delete d[b[e]];if(c?!P(d):!m.isEmptyObject(d))return}(c||(delete g[h].data,P(g[h])))&&(f?m.cleanData([a],!0):k.deleteExpando||g!=g.window?delete g[h]:g[h]=null)}}}m.extend({cache:{},noData:{"applet ":!0,"embed ":!0,"object ":"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"},hasData:function(a){return a=a.nodeType?m.cache[a[m.expando]]:a[m.expando],!!a&&!P(a)},data:function(a,b,c){return Q(a,b,c)},removeData:function(a,b){return R(a,b)},_data:function(a,b,c){return Q(a,b,c,!0)},_removeData:function(a,b){return R(a,b,!0)}}),m.fn.extend({data:function(a,b){var c,d,e,f=this[0],g=f&&f.attributes;if(void 0===a){if(this.length&&(e=m.data(f),1===f.nodeType&&!m._data(f,"parsedAttrs"))){c=g.length;while(c--)g[c]&&(d=g[c].name,0===d.indexOf("data-")&&(d=m.camelCase(d.slice(5)),O(f,d,e[d])));m._data(f,"parsedAttrs",!0)}return e}return"object"==typeof a?this.each(function(){m.data(this,a)}):arguments.length>1?this.each(function(){m.data(this,a,b)}):f?O(f,a,m.data(f,a)):void 0},removeData:function(a){return this.each(function(){m.removeData(this,a)})}}),m.extend({queue:function(a,b,c){var d;return a?(b=(b||"fx")+"queue",d=m._data(a,b),c&&(!d||m.isArray(c)?d=m._data(a,b,m.makeArray(c)):d.push(c)),d||[]):void 0},dequeue:function(a,b){b=b||"fx";var c=m.queue(a,b),d=c.length,e=c.shift(),f=m._queueHooks(a,b),g=function(){m.dequeue(a,b)};"inprogress"===e&&(e=c.shift(),d--),e&&("fx"===b&&c.unshift("inprogress"),delete f.stop,e.call(a,g,f)),!d&&f&&f.empty.fire()},_queueHooks:function(a,b){var c=b+"queueHooks";return m._data(a,c)||m._data(a,c,{empty:m.Callbacks("once memory").add(function(){m._removeData(a,b+"queue"),m._removeData(a,c)})})}}),m.fn.extend({queue:function(a,b){var c=2;return"string"!=typeof a&&(b=a,a="fx",c--),arguments.length<c?m.queue(this[0],a):void 0===b?this:this.each(function(){var c=m.queue(this,a,b);m._queueHooks(this,a),"fx"===a&&"inprogress"!==c[0]&&m.dequeue(this,a)})},dequeue:function(a){return this.each(function(){m.dequeue(this,a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){var c,d=1,e=m.Deferred(),f=this,g=this.length,h=function(){--d||e.resolveWith(f,[f])};"string"!=typeof a&&(b=a,a=void 0),a=a||"fx";while(g--)c=m._data(f[g],a+"queueHooks"),c&&c.empty&&(d++,c.empty.add(h));return h(),e.promise(b)}});var S=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,T=["Top","Right","Bottom","Left"],U=function(a,b){return a=b||a,"none"===m.css(a,"display")||!m.contains(a.ownerDocument,a)},V=m.access=function(a,b,c,d,e,f,g){var h=0,i=a.length,j=null==c;if("object"===m.type(c)){e=!0;for(h in c)m.access(a,b,h,c[h],!0,f,g)}else if(void 0!==d&&(e=!0,m.isFunction(d)||(g=!0),j&&(g?(b.call(a,d),b=null):(j=b,b=function(a,b,c){return j.call(m(a),c)})),b))for(;i>h;h++)b(a[h],c,g?d:d.call(a[h],h,b(a[h],c)));return e?a:j?b.call(a):i?b(a[0],c):f},W=/^(?:checkbox|radio)$/i;!function(){var a=y.createElement("input"),b=y.createElement("div"),c=y.createDocumentFragment();if(b.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",k.leadingWhitespace=3===b.firstChild.nodeType,k.tbody=!b.getElementsByTagName("tbody").length,k.htmlSerialize=!!b.getElementsByTagName("link").length,k.html5Clone="<:nav></:nav>"!==y.createElement("nav").cloneNode(!0).outerHTML,a.type="checkbox",a.checked=!0,c.appendChild(a),k.appendChecked=a.checked,b.innerHTML="<textarea>x</textarea>",k.noCloneChecked=!!b.cloneNode(!0).lastChild.defaultValue,c.appendChild(b),b.innerHTML="<input type='radio' checked='checked' name='t'/>",k.checkClone=b.cloneNode(!0).cloneNode(!0).lastChild.checked,k.noCloneEvent=!0,b.attachEvent&&(b.attachEvent("onclick",function(){k.noCloneEvent=!1}),b.cloneNode(!0).click()),null==k.deleteExpando){k.deleteExpando=!0;try{delete b.test}catch(d){k.deleteExpando=!1}}}(),function(){var b,c,d=y.createElement("div");for(b in{submit:!0,change:!0,focusin:!0})c="on"+b,(k[b+"Bubbles"]=c in a)||(d.setAttribute(c,"t"),k[b+"Bubbles"]=d.attributes[c].expando===!1);d=null}();var X=/^(?:input|select|textarea)$/i,Y=/^key/,Z=/^(?:mouse|pointer|contextmenu)|click/,$=/^(?:focusinfocus|focusoutblur)$/,_=/^([^.]*)(?:\.(.+)|)$/;function ab(){return!0}function bb(){return!1}function cb(){try{return y.activeElement}catch(a){}}m.event={global:{},add:function(a,b,c,d,e){var f,g,h,i,j,k,l,n,o,p,q,r=m._data(a);if(r){c.handler&&(i=c,c=i.handler,e=i.selector),c.guid||(c.guid=m.guid++),(g=r.events)||(g=r.events={}),(k=r.handle)||(k=r.handle=function(a){return typeof m===K||a&&m.event.triggered===a.type?void 0:m.event.dispatch.apply(k.elem,arguments)},k.elem=a),b=(b||"").match(E)||[""],h=b.length;while(h--)f=_.exec(b[h])||[],o=q=f[1],p=(f[2]||"").split(".").sort(),o&&(j=m.event.special[o]||{},o=(e?j.delegateType:j.bindType)||o,j=m.event.special[o]||{},l=m.extend({type:o,origType:q,data:d,handler:c,guid:c.guid,selector:e,needsContext:e&&m.expr.match.needsContext.test(e),namespace:p.join(".")},i),(n=g[o])||(n=g[o]=[],n.delegateCount=0,j.setup&&j.setup.call(a,d,p,k)!==!1||(a.addEventListener?a.addEventListener(o,k,!1):a.attachEvent&&a.attachEvent("on"+o,k))),j.add&&(j.add.call(a,l),l.handler.guid||(l.handler.guid=c.guid)),e?n.splice(n.delegateCount++,0,l):n.push(l),m.event.global[o]=!0);a=null}},remove:function(a,b,c,d,e){var f,g,h,i,j,k,l,n,o,p,q,r=m.hasData(a)&&m._data(a);if(r&&(k=r.events)){b=(b||"").match(E)||[""],j=b.length;while(j--)if(h=_.exec(b[j])||[],o=q=h[1],p=(h[2]||"").split(".").sort(),o){l=m.event.special[o]||{},o=(d?l.delegateType:l.bindType)||o,n=k[o]||[],h=h[2]&&new RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)"),i=f=n.length;while(f--)g=n[f],!e&&q!==g.origType||c&&c.guid!==g.guid||h&&!h.test(g.namespace)||d&&d!==g.selector&&("**"!==d||!g.selector)||(n.splice(f,1),g.selector&&n.delegateCount--,l.remove&&l.remove.call(a,g));i&&!n.length&&(l.teardown&&l.teardown.call(a,p,r.handle)!==!1||m.removeEvent(a,o,r.handle),delete k[o])}else for(o in k)m.event.remove(a,o+b[j],c,d,!0);m.isEmptyObject(k)&&(delete r.handle,m._removeData(a,"events"))}},trigger:function(b,c,d,e){var f,g,h,i,k,l,n,o=[d||y],p=j.call(b,"type")?b.type:b,q=j.call(b,"namespace")?b.namespace.split("."):[];if(h=l=d=d||y,3!==d.nodeType&&8!==d.nodeType&&!$.test(p+m.event.triggered)&&(p.indexOf(".")>=0&&(q=p.split("."),p=q.shift(),q.sort()),g=p.indexOf(":")<0&&"on"+p,b=b[m.expando]?b:new m.Event(p,"object"==typeof b&&b),b.isTrigger=e?2:3,b.namespace=q.join("."),b.namespace_re=b.namespace?new RegExp("(^|\\.)"+q.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=void 0,b.target||(b.target=d),c=null==c?[b]:m.makeArray(c,[b]),k=m.event.special[p]||{},e||!k.trigger||k.trigger.apply(d,c)!==!1)){if(!e&&!k.noBubble&&!m.isWindow(d)){for(i=k.delegateType||p,$.test(i+p)||(h=h.parentNode);h;h=h.parentNode)o.push(h),l=h;l===(d.ownerDocument||y)&&o.push(l.defaultView||l.parentWindow||a)}n=0;while((h=o[n++])&&!b.isPropagationStopped())b.type=n>1?i:k.bindType||p,f=(m._data(h,"events")||{})[b.type]&&m._data(h,"handle"),f&&f.apply(h,c),f=g&&h[g],f&&f.apply&&m.acceptData(h)&&(b.result=f.apply(h,c),b.result===!1&&b.preventDefault());if(b.type=p,!e&&!b.isDefaultPrevented()&&(!k._default||k._default.apply(o.pop(),c)===!1)&&m.acceptData(d)&&g&&d[p]&&!m.isWindow(d)){l=d[g],l&&(d[g]=null),m.event.triggered=p;try{d[p]()}catch(r){}m.event.triggered=void 0,l&&(d[g]=l)}return b.result}},dispatch:function(a){a=m.event.fix(a);var b,c,e,f,g,h=[],i=d.call(arguments),j=(m._data(this,"events")||{})[a.type]||[],k=m.event.special[a.type]||{};if(i[0]=a,a.delegateTarget=this,!k.preDispatch||k.preDispatch.call(this,a)!==!1){h=m.event.handlers.call(this,a,j),b=0;while((f=h[b++])&&!a.isPropagationStopped()){a.currentTarget=f.elem,g=0;while((e=f.handlers[g++])&&!a.isImmediatePropagationStopped())(!a.namespace_re||a.namespace_re.test(e.namespace))&&(a.handleObj=e,a.data=e.data,c=((m.event.special[e.origType]||{}).handle||e.handler).apply(f.elem,i),void 0!==c&&(a.result=c)===!1&&(a.preventDefault(),a.stopPropagation()))}return k.postDispatch&&k.postDispatch.call(this,a),a.result}},handlers:function(a,b){var c,d,e,f,g=[],h=b.delegateCount,i=a.target;if(h&&i.nodeType&&(!a.button||"click"!==a.type))for(;i!=this;i=i.parentNode||this)if(1===i.nodeType&&(i.disabled!==!0||"click"!==a.type)){for(e=[],f=0;h>f;f++)d=b[f],c=d.selector+" ",void 0===e[c]&&(e[c]=d.needsContext?m(c,this).index(i)>=0:m.find(c,this,null,[i]).length),e[c]&&e.push(d);e.length&&g.push({elem:i,handlers:e})}return h<b.length&&g.push({elem:this,handlers:b.slice(h)}),g},fix:function(a){if(a[m.expando])return a;var b,c,d,e=a.type,f=a,g=this.fixHooks[e];g||(this.fixHooks[e]=g=Z.test(e)?this.mouseHooks:Y.test(e)?this.keyHooks:{}),d=g.props?this.props.concat(g.props):this.props,a=new m.Event(f),b=d.length;while(b--)c=d[b],a[c]=f[c];return a.target||(a.target=f.srcElement||y),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,g.filter?g.filter(a,f):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:"char charCode key keyCode".split(" "),filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,b){var c,d,e,f=b.button,g=b.fromElement;return null==a.pageX&&null!=b.clientX&&(d=a.target.ownerDocument||y,e=d.documentElement,c=d.body,a.pageX=b.clientX+(e&&e.scrollLeft||c&&c.scrollLeft||0)-(e&&e.clientLeft||c&&c.clientLeft||0),a.pageY=b.clientY+(e&&e.scrollTop||c&&c.scrollTop||0)-(e&&e.clientTop||c&&c.clientTop||0)),!a.relatedTarget&&g&&(a.relatedTarget=g===a.target?b.toElement:g),a.which||void 0===f||(a.which=1&f?1:2&f?3:4&f?2:0),a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==cb()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){return this===cb()&&this.blur?(this.blur(),!1):void 0},delegateType:"focusout"},click:{trigger:function(){return m.nodeName(this,"input")&&"checkbox"===this.type&&this.click?(this.click(),!1):void 0},_default:function(a){return m.nodeName(a.target,"a")}},beforeunload:{postDispatch:function(a){void 0!==a.result&&a.originalEvent&&(a.originalEvent.returnValue=a.result)}}},simulate:function(a,b,c,d){var e=m.extend(new m.Event,c,{type:a,isSimulated:!0,originalEvent:{}});d?m.event.trigger(e,null,b):m.event.dispatch.call(b,e),e.isDefaultPrevented()&&c.preventDefault()}},m.removeEvent=y.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){var d="on"+b;a.detachEvent&&(typeof a[d]===K&&(a[d]=null),a.detachEvent(d,c))},m.Event=function(a,b){return this instanceof m.Event?(a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||void 0===a.defaultPrevented&&a.returnValue===!1?ab:bb):this.type=a,b&&m.extend(this,b),this.timeStamp=a&&a.timeStamp||m.now(),void(this[m.expando]=!0)):new m.Event(a,b)},m.Event.prototype={isDefaultPrevented:bb,isPropagationStopped:bb,isImmediatePropagationStopped:bb,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=ab,a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=ab,a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){var a=this.originalEvent;this.isImmediatePropagationStopped=ab,a&&a.stopImmediatePropagation&&a.stopImmediatePropagation(),this.stopPropagation()}},m.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(a,b){m.event.special[a]={delegateType:b,bindType:b,handle:function(a){var c,d=this,e=a.relatedTarget,f=a.handleObj;return(!e||e!==d&&!m.contains(d,e))&&(a.type=f.origType,c=f.handler.apply(this,arguments),a.type=b),c}}}),k.submitBubbles||(m.event.special.submit={setup:function(){return m.nodeName(this,"form")?!1:void m.event.add(this,"click._submit keypress._submit",function(a){var b=a.target,c=m.nodeName(b,"input")||m.nodeName(b,"button")?b.form:void 0;c&&!m._data(c,"submitBubbles")&&(m.event.add(c,"submit._submit",function(a){a._submit_bubble=!0}),m._data(c,"submitBubbles",!0))})},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&m.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){return m.nodeName(this,"form")?!1:void m.event.remove(this,"._submit")}}),k.changeBubbles||(m.event.special.change={setup:function(){return X.test(this.nodeName)?(("checkbox"===this.type||"radio"===this.type)&&(m.event.add(this,"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&(this._just_changed=!0)}),m.event.add(this,"click._change",function(a){this._just_changed&&!a.isTrigger&&(this._just_changed=!1),m.event.simulate("change",this,a,!0)})),!1):void m.event.add(this,"beforeactivate._change",function(a){var b=a.target;X.test(b.nodeName)&&!m._data(b,"changeBubbles")&&(m.event.add(b,"change._change",function(a){!this.parentNode||a.isSimulated||a.isTrigger||m.event.simulate("change",this.parentNode,a,!0)}),m._data(b,"changeBubbles",!0))})},handle:function(a){var b=a.target;return this!==b||a.isSimulated||a.isTrigger||"radio"!==b.type&&"checkbox"!==b.type?a.handleObj.handler.apply(this,arguments):void 0},teardown:function(){return m.event.remove(this,"._change"),!X.test(this.nodeName)}}),k.focusinBubbles||m.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(a){m.event.simulate(b,a.target,m.event.fix(a),!0)};m.event.special[b]={setup:function(){var d=this.ownerDocument||this,e=m._data(d,b);e||d.addEventListener(a,c,!0),m._data(d,b,(e||0)+1)},teardown:function(){var d=this.ownerDocument||this,e=m._data(d,b)-1;e?m._data(d,b,e):(d.removeEventListener(a,c,!0),m._removeData(d,b))}}}),m.fn.extend({on:function(a,b,c,d,e){var f,g;if("object"==typeof a){"string"!=typeof b&&(c=c||b,b=void 0);for(f in a)this.on(f,b,c,a[f],e);return this}if(null==c&&null==d?(d=b,c=b=void 0):null==d&&("string"==typeof b?(d=c,c=void 0):(d=c,c=b,b=void 0)),d===!1)d=bb;else if(!d)return this;return 1===e&&(g=d,d=function(a){return m().off(a),g.apply(this,arguments)},d.guid=g.guid||(g.guid=m.guid++)),this.each(function(){m.event.add(this,a,d,c,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,c){var d,e;if(a&&a.preventDefault&&a.handleObj)return d=a.handleObj,m(a.delegateTarget).off(d.namespace?d.origType+"."+d.namespace:d.origType,d.selector,d.handler),this;if("object"==typeof a){for(e in a)this.off(e,b,a[e]);return this}return(b===!1||"function"==typeof b)&&(c=b,b=void 0),c===!1&&(c=bb),this.each(function(){m.event.remove(this,a,c,b)})},trigger:function(a,b){return this.each(function(){m.event.trigger(a,b,this)})},triggerHandler:function(a,b){var c=this[0];return c?m.event.trigger(a,b,c,!0):void 0}});function db(a){var b=eb.split("|"),c=a.createDocumentFragment();if(c.createElement)while(b.length)c.createElement(b.pop());return c}var eb="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",fb=/ jQuery\d+="(?:null|\d+)"/g,gb=new RegExp("<(?:"+eb+")[\\s/>]","i"),hb=/^\s+/,ib=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,jb=/<([\w:]+)/,kb=/<tbody/i,lb=/<|&#?\w+;/,mb=/<(?:script|style|link)/i,nb=/checked\s*(?:[^=]|=\s*.checked.)/i,ob=/^$|\/(?:java|ecma)script/i,pb=/^true\/(.*)/,qb=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,rb={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],area:[1,"<map>","</map>"],param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:k.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},sb=db(y),tb=sb.appendChild(y.createElement("div"));rb.optgroup=rb.option,rb.tbody=rb.tfoot=rb.colgroup=rb.caption=rb.thead,rb.th=rb.td;function ub(a,b){var c,d,e=0,f=typeof a.getElementsByTagName!==K?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==K?a.querySelectorAll(b||"*"):void 0;if(!f)for(f=[],c=a.childNodes||a;null!=(d=c[e]);e++)!b||m.nodeName(d,b)?f.push(d):m.merge(f,ub(d,b));return void 0===b||b&&m.nodeName(a,b)?m.merge([a],f):f}function vb(a){W.test(a.type)&&(a.defaultChecked=a.checked)}function wb(a,b){return m.nodeName(a,"table")&&m.nodeName(11!==b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function xb(a){return a.type=(null!==m.find.attr(a,"type"))+"/"+a.type,a}function yb(a){var b=pb.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function zb(a,b){for(var c,d=0;null!=(c=a[d]);d++)m._data(c,"globalEval",!b||m._data(b[d],"globalEval"))}function Ab(a,b){if(1===b.nodeType&&m.hasData(a)){var c,d,e,f=m._data(a),g=m._data(b,f),h=f.events;if(h){delete g.handle,g.events={};for(c in h)for(d=0,e=h[c].length;e>d;d++)m.event.add(b,c,h[c][d])}g.data&&(g.data=m.extend({},g.data))}}function Bb(a,b){var c,d,e;if(1===b.nodeType){if(c=b.nodeName.toLowerCase(),!k.noCloneEvent&&b[m.expando]){e=m._data(b);for(d in e.events)m.removeEvent(b,d,e.handle);b.removeAttribute(m.expando)}"script"===c&&b.text!==a.text?(xb(b).text=a.text,yb(b)):"object"===c?(b.parentNode&&(b.outerHTML=a.outerHTML),k.html5Clone&&a.innerHTML&&!m.trim(b.innerHTML)&&(b.innerHTML=a.innerHTML)):"input"===c&&W.test(a.type)?(b.defaultChecked=b.checked=a.checked,b.value!==a.value&&(b.value=a.value)):"option"===c?b.defaultSelected=b.selected=a.defaultSelected:("input"===c||"textarea"===c)&&(b.defaultValue=a.defaultValue)}}m.extend({clone:function(a,b,c){var d,e,f,g,h,i=m.contains(a.ownerDocument,a);if(k.html5Clone||m.isXMLDoc(a)||!gb.test("<"+a.nodeName+">")?f=a.cloneNode(!0):(tb.innerHTML=a.outerHTML,tb.removeChild(f=tb.firstChild)),!(k.noCloneEvent&&k.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||m.isXMLDoc(a)))for(d=ub(f),h=ub(a),g=0;null!=(e=h[g]);++g)d[g]&&Bb(e,d[g]);if(b)if(c)for(h=h||ub(a),d=d||ub(f),g=0;null!=(e=h[g]);g++)Ab(e,d[g]);else Ab(a,f);return d=ub(f,"script"),d.length>0&&zb(d,!i&&ub(a,"script")),d=h=e=null,f},buildFragment:function(a,b,c,d){for(var e,f,g,h,i,j,l,n=a.length,o=db(b),p=[],q=0;n>q;q++)if(f=a[q],f||0===f)if("object"===m.type(f))m.merge(p,f.nodeType?[f]:f);else if(lb.test(f)){h=h||o.appendChild(b.createElement("div")),i=(jb.exec(f)||["",""])[1].toLowerCase(),l=rb[i]||rb._default,h.innerHTML=l[1]+f.replace(ib,"<$1></$2>")+l[2],e=l[0];while(e--)h=h.lastChild;if(!k.leadingWhitespace&&hb.test(f)&&p.push(b.createTextNode(hb.exec(f)[0])),!k.tbody){f="table"!==i||kb.test(f)?"<table>"!==l[1]||kb.test(f)?0:h:h.firstChild,e=f&&f.childNodes.length;while(e--)m.nodeName(j=f.childNodes[e],"tbody")&&!j.childNodes.length&&f.removeChild(j)}m.merge(p,h.childNodes),h.textContent="";while(h.firstChild)h.removeChild(h.firstChild);h=o.lastChild}else p.push(b.createTextNode(f));h&&o.removeChild(h),k.appendChecked||m.grep(ub(p,"input"),vb),q=0;while(f=p[q++])if((!d||-1===m.inArray(f,d))&&(g=m.contains(f.ownerDocument,f),h=ub(o.appendChild(f),"script"),g&&zb(h),c)){e=0;while(f=h[e++])ob.test(f.type||"")&&c.push(f)}return h=null,o},cleanData:function(a,b){for(var d,e,f,g,h=0,i=m.expando,j=m.cache,l=k.deleteExpando,n=m.event.special;null!=(d=a[h]);h++)if((b||m.acceptData(d))&&(f=d[i],g=f&&j[f])){if(g.events)for(e in g.events)n[e]?m.event.remove(d,e):m.removeEvent(d,e,g.handle);j[f]&&(delete j[f],l?delete d[i]:typeof d.removeAttribute!==K?d.removeAttribute(i):d[i]=null,c.push(f))}}}),m.fn.extend({text:function(a){return V(this,function(a){return void 0===a?m.text(this):this.empty().append((this[0]&&this[0].ownerDocument||y).createTextNode(a))},null,a,arguments.length)},append:function(){return this.domManip(arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var b=wb(this,a);b.appendChild(a)}})},prepend:function(){return this.domManip(arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var b=wb(this,a);b.insertBefore(a,b.firstChild)}})},before:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c,d=a?m.filter(a,this):this,e=0;null!=(c=d[e]);e++)b||1!==c.nodeType||m.cleanData(ub(c)),c.parentNode&&(b&&m.contains(c.ownerDocument,c)&&zb(ub(c,"script")),c.parentNode.removeChild(c));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){1===a.nodeType&&m.cleanData(ub(a,!1));while(a.firstChild)a.removeChild(a.firstChild);a.options&&m.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){return a=null==a?!1:a,b=null==b?a:b,this.map(function(){return m.clone(this,a,b)})},html:function(a){return V(this,function(a){var b=this[0]||{},c=0,d=this.length;if(void 0===a)return 1===b.nodeType?b.innerHTML.replace(fb,""):void 0;if(!("string"!=typeof a||mb.test(a)||!k.htmlSerialize&&gb.test(a)||!k.leadingWhitespace&&hb.test(a)||rb[(jb.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(ib,"<$1></$2>");try{for(;d>c;c++)b=this[c]||{},1===b.nodeType&&(m.cleanData(ub(b,!1)),b.innerHTML=a);b=0}catch(e){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=arguments[0];return this.domManip(arguments,function(b){a=this.parentNode,m.cleanData(ub(this)),a&&a.replaceChild(b,this)}),a&&(a.length||a.nodeType)?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b){a=e.apply([],a);var c,d,f,g,h,i,j=0,l=this.length,n=this,o=l-1,p=a[0],q=m.isFunction(p);if(q||l>1&&"string"==typeof p&&!k.checkClone&&nb.test(p))return this.each(function(c){var d=n.eq(c);q&&(a[0]=p.call(this,c,d.html())),d.domManip(a,b)});if(l&&(i=m.buildFragment(a,this[0].ownerDocument,!1,this),c=i.firstChild,1===i.childNodes.length&&(i=c),c)){for(g=m.map(ub(i,"script"),xb),f=g.length;l>j;j++)d=i,j!==o&&(d=m.clone(d,!0,!0),f&&m.merge(g,ub(d,"script"))),b.call(this[j],d,j);if(f)for(h=g[g.length-1].ownerDocument,m.map(g,yb),j=0;f>j;j++)d=g[j],ob.test(d.type||"")&&!m._data(d,"globalEval")&&m.contains(h,d)&&(d.src?m._evalUrl&&m._evalUrl(d.src):m.globalEval((d.text||d.textContent||d.innerHTML||"").replace(qb,"")));i=c=null}return this}}),m.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){m.fn[a]=function(a){for(var c,d=0,e=[],g=m(a),h=g.length-1;h>=d;d++)c=d===h?this:this.clone(!0),m(g[d])[b](c),f.apply(e,c.get());return this.pushStack(e)}});var Cb,Db={};function Eb(b,c){var d,e=m(c.createElement(b)).appendTo(c.body),f=a.getDefaultComputedStyle&&(d=a.getDefaultComputedStyle(e[0]))?d.display:m.css(e[0],"display");return e.detach(),f}function Fb(a){var b=y,c=Db[a];return c||(c=Eb(a,b),"none"!==c&&c||(Cb=(Cb||m("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),b=(Cb[0].contentWindow||Cb[0].contentDocument).document,b.write(),b.close(),c=Eb(a,b),Cb.detach()),Db[a]=c),c}!function(){var a;k.shrinkWrapBlocks=function(){if(null!=a)return a;a=!1;var b,c,d;return c=y.getElementsByTagName("body")[0],c&&c.style?(b=y.createElement("div"),d=y.createElement("div"),d.style.cssText="position:absolute;border:0;width:0;height:0;top:0;left:-9999px",c.appendChild(d).appendChild(b),typeof b.style.zoom!==K&&(b.style.cssText="-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1",b.appendChild(y.createElement("div")).style.width="5px",a=3!==b.offsetWidth),c.removeChild(d),a):void 0}}();var Gb=/^margin/,Hb=new RegExp("^("+S+")(?!px)[a-z%]+$","i"),Ib,Jb,Kb=/^(top|right|bottom|left)$/;a.getComputedStyle?(Ib=function(a){return a.ownerDocument.defaultView.getComputedStyle(a,null)},Jb=function(a,b,c){var d,e,f,g,h=a.style;return c=c||Ib(a),g=c?c.getPropertyValue(b)||c[b]:void 0,c&&(""!==g||m.contains(a.ownerDocument,a)||(g=m.style(a,b)),Hb.test(g)&&Gb.test(b)&&(d=h.width,e=h.minWidth,f=h.maxWidth,h.minWidth=h.maxWidth=h.width=g,g=c.width,h.width=d,h.minWidth=e,h.maxWidth=f)),void 0===g?g:g+""}):y.documentElement.currentStyle&&(Ib=function(a){return a.currentStyle},Jb=function(a,b,c){var d,e,f,g,h=a.style;return c=c||Ib(a),g=c?c[b]:void 0,null==g&&h&&h[b]&&(g=h[b]),Hb.test(g)&&!Kb.test(b)&&(d=h.left,e=a.runtimeStyle,f=e&&e.left,f&&(e.left=a.currentStyle.left),h.left="fontSize"===b?"1em":g,g=h.pixelLeft+"px",h.left=d,f&&(e.left=f)),void 0===g?g:g+""||"auto"});function Lb(a,b){return{get:function(){var c=a();if(null!=c)return c?void delete this.get:(this.get=b).apply(this,arguments)}}}!function(){var b,c,d,e,f,g,h;if(b=y.createElement("div"),b.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",d=b.getElementsByTagName("a")[0],c=d&&d.style){c.cssText="float:left;opacity:.5",k.opacity="0.5"===c.opacity,k.cssFloat=!!c.cssFloat,b.style.backgroundClip="content-box",b.cloneNode(!0).style.backgroundClip="",k.clearCloneStyle="content-box"===b.style.backgroundClip,k.boxSizing=""===c.boxSizing||""===c.MozBoxSizing||""===c.WebkitBoxSizing,m.extend(k,{reliableHiddenOffsets:function(){return null==g&&i(),g},boxSizingReliable:function(){return null==f&&i(),f},pixelPosition:function(){return null==e&&i(),e},reliableMarginRight:function(){return null==h&&i(),h}});function i(){var b,c,d,i;c=y.getElementsByTagName("body")[0],c&&c.style&&(b=y.createElement("div"),d=y.createElement("div"),d.style.cssText="position:absolute;border:0;width:0;height:0;top:0;left:-9999px",c.appendChild(d).appendChild(b),b.style.cssText="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute",e=f=!1,h=!0,a.getComputedStyle&&(e="1%"!==(a.getComputedStyle(b,null)||{}).top,f="4px"===(a.getComputedStyle(b,null)||{width:"4px"}).width,i=b.appendChild(y.createElement("div")),i.style.cssText=b.style.cssText="-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",i.style.marginRight=i.style.width="0",b.style.width="1px",h=!parseFloat((a.getComputedStyle(i,null)||{}).marginRight)),b.innerHTML="<table><tr><td></td><td>t</td></tr></table>",i=b.getElementsByTagName("td"),i[0].style.cssText="margin:0;border:0;padding:0;display:none",g=0===i[0].offsetHeight,g&&(i[0].style.display="",i[1].style.display="none",g=0===i[0].offsetHeight),c.removeChild(d))}}}(),m.swap=function(a,b,c,d){var e,f,g={};for(f in b)g[f]=a.style[f],a.style[f]=b[f];e=c.apply(a,d||[]);for(f in b)a.style[f]=g[f];return e};var Mb=/alpha\([^)]*\)/i,Nb=/opacity\s*=\s*([^)]*)/,Ob=/^(none|table(?!-c[ea]).+)/,Pb=new RegExp("^("+S+")(.*)$","i"),Qb=new RegExp("^([+-])=("+S+")","i"),Rb={position:"absolute",visibility:"hidden",display:"block"},Sb={letterSpacing:"0",fontWeight:"400"},Tb=["Webkit","O","Moz","ms"];function Ub(a,b){if(b in a)return b;var c=b.charAt(0).toUpperCase()+b.slice(1),d=b,e=Tb.length;while(e--)if(b=Tb[e]+c,b in a)return b;return d}function Vb(a,b){for(var c,d,e,f=[],g=0,h=a.length;h>g;g++)d=a[g],d.style&&(f[g]=m._data(d,"olddisplay"),c=d.style.display,b?(f[g]||"none"!==c||(d.style.display=""),""===d.style.display&&U(d)&&(f[g]=m._data(d,"olddisplay",Fb(d.nodeName)))):(e=U(d),(c&&"none"!==c||!e)&&m._data(d,"olddisplay",e?c:m.css(d,"display"))));for(g=0;h>g;g++)d=a[g],d.style&&(b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?f[g]||"":"none"));return a}function Wb(a,b,c){var d=Pb.exec(b);return d?Math.max(0,d[1]-(c||0))+(d[2]||"px"):b}function Xb(a,b,c,d,e){for(var f=c===(d?"border":"content")?4:"width"===b?1:0,g=0;4>f;f+=2)"margin"===c&&(g+=m.css(a,c+T[f],!0,e)),d?("content"===c&&(g-=m.css(a,"padding"+T[f],!0,e)),"margin"!==c&&(g-=m.css(a,"border"+T[f]+"Width",!0,e))):(g+=m.css(a,"padding"+T[f],!0,e),"padding"!==c&&(g+=m.css(a,"border"+T[f]+"Width",!0,e)));return g}function Yb(a,b,c){var d=!0,e="width"===b?a.offsetWidth:a.offsetHeight,f=Ib(a),g=k.boxSizing&&"border-box"===m.css(a,"boxSizing",!1,f);if(0>=e||null==e){if(e=Jb(a,b,f),(0>e||null==e)&&(e=a.style[b]),Hb.test(e))return e;d=g&&(k.boxSizingReliable()||e===a.style[b]),e=parseFloat(e)||0}return e+Xb(a,b,c||(g?"border":"content"),d,f)+"px"}m.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Jb(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":k.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,c,d){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var e,f,g,h=m.camelCase(b),i=a.style;if(b=m.cssProps[h]||(m.cssProps[h]=Ub(i,h)),g=m.cssHooks[b]||m.cssHooks[h],void 0===c)return g&&"get"in g&&void 0!==(e=g.get(a,!1,d))?e:i[b];if(f=typeof c,"string"===f&&(e=Qb.exec(c))&&(c=(e[1]+1)*e[2]+parseFloat(m.css(a,b)),f="number"),null!=c&&c===c&&("number"!==f||m.cssNumber[h]||(c+="px"),k.clearCloneStyle||""!==c||0!==b.indexOf("background")||(i[b]="inherit"),!(g&&"set"in g&&void 0===(c=g.set(a,c,d)))))try{i[b]=c}catch(j){}}},css:function(a,b,c,d){var e,f,g,h=m.camelCase(b);return b=m.cssProps[h]||(m.cssProps[h]=Ub(a.style,h)),g=m.cssHooks[b]||m.cssHooks[h],g&&"get"in g&&(f=g.get(a,!0,c)),void 0===f&&(f=Jb(a,b,d)),"normal"===f&&b in Sb&&(f=Sb[b]),""===c||c?(e=parseFloat(f),c===!0||m.isNumeric(e)?e||0:f):f}}),m.each(["height","width"],function(a,b){m.cssHooks[b]={get:function(a,c,d){return c?Ob.test(m.css(a,"display"))&&0===a.offsetWidth?m.swap(a,Rb,function(){return Yb(a,b,d)}):Yb(a,b,d):void 0},set:function(a,c,d){var e=d&&Ib(a);return Wb(a,c,d?Xb(a,b,d,k.boxSizing&&"border-box"===m.css(a,"boxSizing",!1,e),e):0)}}}),k.opacity||(m.cssHooks.opacity={get:function(a,b){return Nb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=m.isNumeric(b)?"alpha(opacity="+100*b+")":"",f=d&&d.filter||c.filter||"";c.zoom=1,(b>=1||""===b)&&""===m.trim(f.replace(Mb,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||d&&!d.filter)||(c.filter=Mb.test(f)?f.replace(Mb,e):f+" "+e)}}),m.cssHooks.marginRight=Lb(k.reliableMarginRight,function(a,b){return b?m.swap(a,{display:"inline-block"},Jb,[a,"marginRight"]):void 0}),m.each({margin:"",padding:"",border:"Width"},function(a,b){m.cssHooks[a+b]={expand:function(c){for(var d=0,e={},f="string"==typeof c?c.split(" "):[c];4>d;d++)e[a+T[d]+b]=f[d]||f[d-2]||f[0];return e}},Gb.test(a)||(m.cssHooks[a+b].set=Wb)}),m.fn.extend({css:function(a,b){return V(this,function(a,b,c){var d,e,f={},g=0;if(m.isArray(b)){for(d=Ib(a),e=b.length;e>g;g++)f[b[g]]=m.css(a,b[g],!1,d);return f}return void 0!==c?m.style(a,b,c):m.css(a,b)},a,b,arguments.length>1)},show:function(){return Vb(this,!0)},hide:function(){return Vb(this)},toggle:function(a){return"boolean"==typeof a?a?this.show():this.hide():this.each(function(){U(this)?m(this).show():m(this).hide()})}});function Zb(a,b,c,d,e){return new Zb.prototype.init(a,b,c,d,e)}m.Tween=Zb,Zb.prototype={constructor:Zb,init:function(a,b,c,d,e,f){this.elem=a,this.prop=c,this.easing=e||"swing",this.options=b,this.start=this.now=this.cur(),this.end=d,this.unit=f||(m.cssNumber[c]?"":"px")
        ...
        self.htmlJavaScript = r"""<script type="text/javascript">
function generateFilterButtonId(jsonElementId) {
    return '' + jsonElementId + '-filter-button';
}
function generateDivElementId(jsonElementId) {
    return '' + jsonElementId + '-info';
}
function showHideNonhighlightedRows(jsonElementId) {
    var divElementId = '' + jsonElementId + '-info';
    var filterButtonId = jsonElementId + '-filter-button';
    
    var hiddenRows = $('#' + divElementId).find('tr.hidden');
    var nonHighlightedRows = $('#' + divElementId).find('tr:gt(0):not(.highlight)');
    
    if (hiddenRows.length > 0) {
        nonHighlightedRows.removeClass('hidden');
        $('#' + filterButtonId).attr("value", "Show highlighted only");
    } else {
        nonHighlightedRows.addClass('hidden');
        $('#' + filterButtonId).attr("value", "Show all");
    }
}
function generateIncludesTableRows(jqRowAnchorElement, jsonData, filter) {
    // Add table data.
    var i = 0, j = 0;
    var newRow, newCell, filename, includeType, lineNumber;
    for (i = 0; i < jsonData.length; ++i) {
        filename = jsonData[i]['file'];
        
        for (var includeText in jsonData[i]['include-list'])
        {
            for (j = 0; j < jsonData[i]['include-list'][includeText].length; ++j)
            {
                newRow = $('<tr></tr>');
                if (j > 0) newRow.addClass('duplicate');
                if (filter) {
                    if ((filter.option.files && filter.re.test(filename)) || (filter.option.includes && filter.re.test(includeText)))
                    {
                ...
                newCell = $('<td>' + filename + '</td>');
                newRow.append(newCell);
                
                newCell = $('<td>' + includeText + '</td>');
                newRow.append(newCell);
                
                newCell = $('<td>' + jsonData[i]['include-list'][includeText][j]['line-number'] + '</td>');
                newRow.append(newCell);
                
                newCell = $('<td>' + jsonData[i]['include-list'][includeText][j]['include-type'] + '</td>');
                newRow.append(newCell);
                
                jqRowAnchorElement.append(newRow);
            }
        }
    }
}
function generateIncludesTable(jsonElementId, filter) {
    // Damn, we have to do work now. Fiesta's over, let's get to it!
    // Get the JSON data
    var element = $('#' + jsonElementId);
    
    if (element && element.length) {        
        try {
            jsonData = JSON.parse(element.text());
        } catch (e) {
        ...
        var newElement = $('<div id="' + generateDivElementId(jsonElementId) + '" class="headerlist"></div>');
        
        // Add the close button and any other buttons we need.
        var buttonHeader = $('<div class="button-header"></div>');
        var closeButton = $('<input type="button" value="&#10006;" class="close-button" onclick="javascript:showHide(\'' + jsonElementId + '\', \'hide\');">');
        buttonHeader.append(closeButton);
        if (filter) {
            var filterButton = $('<input id="' + generateFilterButtonId(jsonElementId) + '" class="subtable-extra-button" type="button" value="Show all" onclick="javascript:showHideNonhighlightedRows(\'' + jsonElementId + '\');">');
            buttonHeader.append(filterButton);
        }
        newElement.append(buttonHeader);
        
        // Add the table
        var newTable = $('<table class="includes-table"><thead><tr><th>File</th><th>Include Text</th><th>Line Number</th><th>Include Type</th></tr></thead></table>');
        var newTableBody = $('<tbody></tbody>');
        
        newTable.append(newTableBody);
        newElement.append(newTable);
        
        generateIncludesTableRows(newTableBody, jsonData, filter);
...
function showHide(jsonElementId, action) {
    var doTableGeneration = true;
    
    // Check for any existing filters.
    var filter = getCurrentFilter();
    var filterButtonId = generateFilterButtonId(jsonElementId);
    
    // The elementId points to the element containing the JSON data which contains all the files
    // and their respective #includes.
    
    // Compute the id of the sibling div which will contain the display table.
    var divElementId = generateDivElementId(jsonElementId);
    
    // Check if we have already generated this table
    var element = $('#' + divElementId);
    if (element && element.length > 0)
    {
        // Yus!!! We don't have to compute it, just manipulate the hidden class, for show/hide.
        doTableGeneration = false;
        
        if (action === "show")
        {
            if (filter) {
                element.remove();
                doTableGeneration = true;
                // Crap, got screwed over by the filter... No I have to do it again!
            } else {
                element.find('tr.highlight').removeClass('highlight');
                element.find('tr.hidden').removeClass('hidden');
    ...
    if (doTableGeneration) {
        generateIncludesTable(jsonElementId, filter);
    }
}
...
function highlightCol(colId, elementClassName) {
    var colElement = $('#' + colId);
    var elements = $('.' + elementClassName);
    var i = 0;
    
    if (colElement && elements)
    {
        if (colElement.hasClass("highlight"))
        {
            colElement.removeClass("highlight");
...
/* Hides the dynamic row/column sums that show on hover over the headings */
function HideSumTable() {
    $("#sum-table").remove();
}
/* Shows the dynamic row/column sums that show on hover over the headings */
function DisplaySumTable(parent, errorSum, warningSum, dependenciesSum) {
    var container = $('<div id="sum-table"></div>').html(
        $("<table></table>").append(
            $("<thead></thead>").append(
                $("<tr></tr>").append(
                    $("<th></th>").text("Values summed")
                ).append(
                    $("<th></th>").text("Total")
                )
            )
            ...
            $("<tbody></tbody>").append(
                $("<tr></tr>").append(
                    $("<td></td>").text("Dependencies")
                ).append(
                    $("<td></td>").text(dependenciesSum)
                )
            ).append(
                $("<tr></tr>").append(
                    $('<td class="warning"></td>').text("Independency errors")
                ).append(
                    $('<td class="warning"></td>').text(warningSum)
                )
            ).append(
                $("<tr></tr>").append(
                    $('<td class="error"></td>').append($('<span class="include-count"></span>').text("Circular dependencies"))
                ).append(
                    $('<td class="error"></td>').append($('<span class="include-count"></span>').text(errorSum))
                )
            )
        )
    );
    ...
    pos.left += parent.width();;
    
    container.css({top: pos.top, left: pos.left, position:'absolute'});
    $("body").append(container);
}
/* Computes and then shows the dynamic row sums that show on hover over the headings */
function ComputeRowTotals(rowId) {
    var selectorPrefix = '#' + rowId;
    var errors = $(selectorPrefix + ' td.error');
    var warnings = $(selectorPrefix + ' td.warning');
    var dependencies = $(selectorPrefix + ' td').not(selectorPrefix + ' td.warning').not(selectorPrefix + ' td.error').not(selectorPrefix + ' td.independent');
    
    var errorSum = 0;
    var warningSum = 0;
    var dependenciesSum = 0;
    
    errors.each(function () {
        $(this).find('span.include-count').each(function () {
            errorSum += parseInt($(this).text())
        });
    });
    warnings.each(function () {
        $(this).find('span.include-count').each(function () {
            warningSum += parseInt($(this).text())
        });
    });
    dependencies.each(function () {
        $(this).find('span.include-count').each(function () {
            dependenciesSum += parseInt($(this).text())
        });
    });
    
    parent = $(selectorPrefix + ' > th')
    DisplaySumTable(parent, errorSum, warningSum, dependenciesSum);
}
/* Computes and then shows the dynamic column sums that show on hover over the headings */
function ComputeColumnTotals(columnClass) {
    var selectorPrefix = 'td.' + columnClass;
    var errors = $(selectorPrefix + '.error');
    var warnings = $(selectorPrefix + '.warning');
    var dependencies = $(selectorPrefix).not(selectorPrefix + '.warning').not(selectorPrefix + '.error').not(selectorPrefix + '.independent');
    ...
    colIndex = $(selectorPrefix).index();
    parent = $('tr:first th:eq(' + colIndex + ')')
    DisplaySumTable(parent, errorSum, warningSum, dependenciesSum);
}
/* Search/Filter functions */
function find(searchText, options) {
    if (searchText) {
        ...
        $('.jsondata').each(function () {
            ...
            for (i = 0; i < jsonData.length; ++i) {
                var filename = jsonData[i]['file'];
                
                if (options.files && re.test(filename)) {
                    count += Object.keys(jsonData[i]['include-list']).length;
                } else {
                    for (var includeText in jsonData[i]['include-list']) {
                        if (options.includes && re.test(includeText))
                        {
                            count++;
                        }
                    }
            ...
            var countElem = container.children('span.include-count');
            countElem.addClass('hidden');
            if (count > 0)
            {
                var newCountElem = $('<span class="include-count js-computed-sum"></span>').text(count);
                container.append(newCountElem);
            }
        });
    } else {
        $('table.includes-table tr td.highlight').each(function () {
            $(this).removeClass("highlight");
        });
        $('.jsondata').each(function () {
            var container = $(this).parent();
            container.children('span.include-count').removeClass('hidden');
            container.children('.js-computed-sum').remove();
        });
    }
}
function applyFilter() {
    var searchFiles = $('#filter-files').prop('checked');
    var searchIncludes = $('#filter-includes').prop('checked');
    
    // Validate the search
    if (!searchFiles && !searchIncludes) {
        alert('You must check one option, Files or Includes in order for the search to work!');
        return;
    }
    
    // Do the search
    var filterText = $('#filter-text').val();
    find(filterText, { files: searchFiles, includes: searchIncludes });
    
    // Save the filter
    var lastFilterTextElement = $('<div id="last-filter-text" class="hidden" files-option="' + searchFiles + '" includes-option="' + searchIncludes + '">' + filterText + '</div>');
    $('body').append(lastFilterTextElement);
}
function clearFilter() {
    find('');
    $('#last-filter-text').remove();
}
function getCurrentFilter() {
    var filterElement = $('#last-filter-text');
    var filterOptions = false;
    
    if (filterElement && filterElement.length > 0) {
        filterOptions = { text: filterElement.text(), option: { files: filterElement.attr('files-option'), includes: filterElement.attr('includes-option') } };
        filterOptions.re = new RegExp(filterOptions.text);
    }
    
    return filterOptions;
}

/* computeMatrixTableDiff function computes a diff for the main table on the basis of the numeric
 * counts contained in each cell. This function will alter the DOM to re-represent the matrix
 * table as a diff.
 */
function computeMatrixTableDiff() {
    var frame = $('#diff-frame');
    
    var thisCols = false;
    var otherCols = false;
    
    try {
        // Compute a column diff and generate a mapping from our table to the other table
        thisCols = $('#dependency-matrix > thead > tr > th > div > span');
        otherCols = frame.contents().find('#dependency-matrix > thead > tr > th > div > span');
    } catch (e) {
        alert('Error computing diff!\n\nYour browser does not seem to support accessing the DOM of an IFRAME!\n\nError message: ' + e.message);
        return;
    }
    
    var colMap = [];
    
    for (var i = 0; i < thisCols.length; i++)
    {
        colMap[i] = -1;
        
        for (var j = 0; j < otherCols.length; j++) {
            if (thisCols.eq(i).text() === otherCols.eq(j).text()) {
                // Map this column index to other column index.
                colMap[i] = j;
                break;
            }
        }
    ...
    // Compute a row diff based on header names and create a mapping between the two tables
    var thisRows = $('#dependency-matrix > tbody > tr > th');
    var otherRows = frame.contents().find('#dependency-matrix > tbody > tr > th');
    ...
    for (var i = 0; i < thisRows.length; i++)
    {
        ...
        for (var j = 0; j < otherRows.length; j++) {
            if (thisRows.eq(i).text() === otherRows.eq(j).text()) {
                // Map this row index to other row index.
                rowMap[i] = j;
                break;
            }
        }
    ...
    // Do individual row diffs
    
    // Iterate over rows and diff each row.
    
    var i = 0;
    var thisRows = $('#dependency-matrix > tbody > tr');
    var otherRows = frame.contents().find('#dependency-matrix > tbody > tr');
    
    thisRows.each(function () {
        // For each row in the Dependency Matrix
        var thisItems = $(this).children('td');
        var otherItems = otherRows.eq(rowMap[i]).children('td');
        
        var selector = '';
        
        for (var j = 0; j < thisItems.length; ++j) {
            if (colMap[j] < 0) continue;
            
            var thisItem = thisItems.eq(j);
            var otherItem = otherItems.eq(colMap[j]);
            
            // Diff the two table items.
            var thisCountItem = thisItem.find('.include-count');
            var otherCountItem = otherItem.find('.include-count');
            
            var thisCount = 0;
            if (thisCountItem.length > 0) {
                thisCount = parseInt(thisCountItem.text());
                
            }
            
            var otherCount = 0;
            if (otherCountItem.length > 0) {
                otherCount = parseInt(otherCountItem.text());
            }
            
            var diffCount = thisCount - otherCount;
            var diffCountStr = '';
            var diffClass = 'diff-same'
            if (diffCount < 0) {
                diffCountStr = '' + diffCount;
            ...
            var newCount = $('<span class="diff-count"></span>').text(diffCountStr);
            
            if (thisCountItem.length > 0)
            {
                thisCountItem.addClass('hidden');
                thisCountItem.parent().append(newCount);
            } else
            {
                newCountWrapper = $('<div class="diff-wrapper"></div>').append(newCount);
                thisItem.append(newCountWrapper);
            }
            thisItem.addClass(diffClass);
        }
        
        i++;
    });
}
/* This function applies the diff between this page and the target file which has been entered in
 * the diff text box. It prepares the IFRAME and calls a helper function to compute the diff.
 */
function applyDiff() {
    var frame = $('#diff-frame');
    ...
    // Create IFRAME element pointing to the page we are diffing against.
    var anchor = $('#diff-anchor');
    
    frame = $('<iframe id="diff-frame" onload="computeMatrixTableDiff()"></iframe>').attr('src', $('input#diff-path').val());
    frame.addClass('hidden');
    
    anchor.append(frame);
}
/* This function clears the currently applied diff and restores the tables original state */
function clearDiff() {
    // Remove the IFRAME
    var anchor = $('#diff-anchor');
    anchor.remove('#diff-frame');
    
    // Restore the table state
    $('.diff-wrapper').remove();
    $('.diff-count').remove();
    $('.include-count').each(function () {
        $(this).removeClass('hidden');
    });
    
    // Remove the diff colouring markers.
    $('.diff-same').each(function () {
        $(this).removeClass('diff-same');
    });
    $('.diff-added').each(function () {
        $(this).removeClass('diff-added');
    });
    $('.diff-removed').each(function () {
        $(this).removeClass('diff-removed');
    });
}
</script>"""
...
function initJsonData() {
    ...
    {
        // Unpack the data so we don't have to have too much indirection.
        window.projectGroups = window.projectGroups.object;
    }
}
/* getProjectGroup - Gets the project group to which the project with the given projectName belongs */
function getProjectGroup(projectName) {
    ...
    {
        for (j = 0; j < groups[i].projects.length; ++j)
        {
            if (groups[i].projects[j].name === projectName)
            {
                return groups[i];
            }
        }
...
function applyProjectGroupsCSS() {
    var func = function() {
        var projectText = $(this).text();
        var projectGroup = getProjectGroup(projectText);
        if (projectGroup && projectGroup.css)
        {
            for (var prop in projectGroup.css)
            {
                $(this).css(prop, projectGroup.css[prop]);
            }
            
        }
    };
    
    $('#dependency-matrix tr:first th > div > span').each(func);
    $('#dependency-matrix tr:gt(0) th').each(func);
}
function initStart() {
    initJsonData();
    ...
    def GenerateHtml(self, outFilename = None):
        ...
        SELECT p.Name AS ProjectName,
               ...
               i.IncludeText AS IncludeText,
               i.IncludeType AS IncludeType,
               i.IncludeFilename AS IncludeFilename,
               i.LineNumber AS LineNumber,
               i.IncludeProject AS IncludeProject
        FROM Project p
        LEFT JOIN CodeFile f ON p.Name = f.Project
        ...
        # Iterate over the result set and generate an HTML table.
        row = self.database.cur.fetchone()
        while row:
        ...
        if currentProject != projectOrderList[-1]:
            ...
            # to any one of the columns in the last row which will force the writer to write out
...
<table class="layout-table">
    <tbody>
        <tr>
            <td>            
                ...
                <div class="legend">
                    <table id="dependency-matrix-legend">
                        <caption>Project Dependency Matrix Totals</caption>
                        <thead>
                            <tr>
                                <th>Value summed</th><th>Total</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <td>
                <table id="inputs-table" class="layout-table">
                    <tbody>
                        <tr>
                            <th><div class="title">Filter Regex:</div></th>
                            <td><input id="filter-text" type="text"></td>
                            <td><input type="button" value="Apply" onclick="javascript:applyFilter();"></td>
                            <td><input type="button" value="Clear" onclick="javascript:clearFilter();"></td>
                            <td><div class="input-options"><span>Files <input id="filter-files" type="checkbox" checked="checked">Includes <input id="filter-includes" type="checkbox" checked="checked"></span></div></td>
                        </tr>
                        <tr>
                            <th>Diff to other:</th>
                            <td><input id="diff-path" type="text"></td>
                            <td><input type="button" value="Diff" onclick="javascript:applyDiff();"></td>
                            <td><input type="button" value="Clear" onclick="javascript:clearDiff();"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="5">
                                ...
                                Notes on diffs:<br />
                                    <ul>
                                        <li>Chrome: you need to start it with <b>--allow-file-access-from-files</b> for diffs to work. See <a href="http://stackoverflow.com/questions/5111306/call-a-javascript-function-defined-in-an-iframe-in-chrome-using-the-file-protoco">this stack overflow answer</a> and <a href="http://www.chrome-allow-file-access-from-file.com/">this helpful link</a> for details</li>
                                        <li>Firefox: Diffs between HTML pages in the same folder work (takes around 30 sec).</li>
                                        <li>Internet Explorer: Works on files in different folders (takes around 1 min).</li>
                                        <li>Misc. leet browser: Untested, unsupported! Patches accepted :)</li>
                                    </ul>
                                </i>
                            </td>
                        </tr>
...
""")
        ...
        if self.config.printTotalViolations:
            self.config.messagePrinter.info("Totals:")
            self.config.messagePrinter.info("  Project hierarchy violations:  {0}".format(totalHierarchyViolations))
            self.config.messagePrinter.info("  Project dependency violations: {0}".format(totalPotentialViolations))
            self.config.messagePrinter.info("  Internal linkage:              {0}".format(totalInternalLinkage))
...
def Main(argv):
    ...
    if config.printExampleConfig:
        ...
        if config.reuseDatabase and os.path.exists(config.databaseFilename):
            ...
            if not slnProcessor.PopulateDatabase():
...
if __name__ == "__main__":
    rv = Main(sys.argv)
    if rv > 0:
        # Dependencies detected and need to result in failure.
        sys.exit(1)
    elif rv < 0:
        # Internal error
        sys.exit(2)
